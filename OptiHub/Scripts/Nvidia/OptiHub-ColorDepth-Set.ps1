# OptiHub - set NVIDIA display color bit depth via NVAPI helper.
# Usage: OptiHub-ColorDepth-Set.ps1 -Depth 10 [-DisplayId 12345]
param(
...
if (-not $exe) {
    Write-Host 'OPTIHUB_NVDISPLAY_JSON:{"ok":false,"error":"helper-missing"}'
    exit 2
}
