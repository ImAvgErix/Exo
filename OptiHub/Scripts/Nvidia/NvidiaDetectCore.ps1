...
function Get-OptiHubGpuSeriesFromName {
...
function Test-OptiHubProfileNameMatchesSeries {
    ...
    $expected = Get-OptiHubExpectedProfileFileName -SeriesId $Series -Gsync $Gsync
