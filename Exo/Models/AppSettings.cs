...
public sealed class AppSettings
{
    ...
    public string DiscordKitVersion { get; set; } = "1.3.88";
    ...
    /// <summary>Shell text colour: "white" or "grey". Drives the --exo-text custom property.</summary>
    public string TextColour { get; set; } = "white";

    /// <summary>Shell text size: "small", "normal" or "large". Drives the --exo-scale custom property.</summary>
