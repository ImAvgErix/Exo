...
public sealed class ExoToolRegistry
{
    ...
    private void RegisterBuiltins()
    {
        ...
        Register(new DelegateTool("memory.islc", ExoToolCategory.OsCore, "ISLC standby-list trim (opt-in; exclusive vs compressionOff)", ModuleStub));
        Register(new DelegateTool("memory.compressionOff", ExoToolCategory.OsCore, "Memory compression off (exclusive vs ISLC)", ModuleStub));
