...
public sealed class AppServices
{
    ...
    public TweakCatalog Tweaks { get; } = TweakCatalog.CreateDefault();
    public StartupServicesManager StartupServices { get; } = new();
    public StorageMaintenanceService Storage { get; } = new();
