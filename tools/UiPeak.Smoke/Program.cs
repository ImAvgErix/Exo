...
if (File.Exists(versionFile))
    Expect("VERSION is 2.2.5", File.ReadAllText(versionFile).Trim() == "2.2.5");
if (File.Exists(csproj))
    Expect("csproj Version 2.2.5", File.ReadAllText(csproj).Contains("<Version>2.2.5</Version>", StringComparison.Ordinal));
