...
if (File.Exists(versionFile))
    Expect("VERSION is 2.3.3", File.ReadAllText(versionFile).Trim() == "2.3.3");
if (File.Exists(csproj))
    Expect("csproj Version 2.3.3", File.ReadAllText(csproj).Contains("<Version>2.3.3</Version>", StringComparison.Ordinal));
