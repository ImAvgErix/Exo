...
if (File.Exists(versionFile))
    Expect("VERSION is 2.2.6", File.ReadAllText(versionFile).Trim() == "2.2.6");
if (File.Exists(csproj))
    Expect("csproj Version 2.2.6", File.ReadAllText(csproj).Contains("<Version>2.2.6</Version>", StringComparison.Ordinal));
