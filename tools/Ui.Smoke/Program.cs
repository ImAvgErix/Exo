...
if (File.Exists(versionFile))
    Expect("VERSION is 3.0.7", File.ReadAllText(versionFile).Trim() == "3.0.7");
if (File.Exists(csproj))
    Expect("csproj Version 3.0.7", File.ReadAllText(csproj).Contains("<Version>3.0.7</Version>", StringComparison.Ordinal));
