...
if (File.Exists(versionFile))
    Expect("VERSION is 3.0.6", File.ReadAllText(versionFile).Trim() == "3.0.6");
if (File.Exists(csproj))
    Expect("csproj Version 3.0.6", File.ReadAllText(csproj).Contains("<Version>3.0.6</Version>", StringComparison.Ordinal));
